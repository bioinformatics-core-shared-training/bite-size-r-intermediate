...
```{r}
### Your answer here...
tidyData <- gather(messyData, Drug, Value, -Subject)
boxplot(tidyData$Value~tidyData$Drug)
```
...
spread(tidyData, key = Drug, value=Value)
separate(tidyData,col = Drug,into=c("Drug","Replicate"))
```
