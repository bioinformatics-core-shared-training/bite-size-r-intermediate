...
We have already seen a ***tidy*** dataset in the form of [Fisher's iris dataset](https://en.wikipedia.org/wiki/Iris_flower_data_set). As saw, it was possible to produce visualisations of the data using the `~` syntax.
