...
* Use the ID column to combine information about patients with the blood pressure and glucose measurements.

* Refine this to only include the most recent blood pressure and glucose measurements for each patient.
