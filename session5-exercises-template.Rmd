...
8. Assign a priority to the mapping for each gene symbol based on the order of precedence
...
Check if you need to remove grouping in your data frame after adding the priority.

8. Use the gene symbol lookup table
...
9. Using just the preferred mappings, compute the number of symbols in each class and the percentage of those that map to a HGNC gene with an Ensembl cross-reference
