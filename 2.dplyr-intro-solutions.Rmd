...
```{r}
clinicalData <- separate(clinicalData, Treatment, into = c("Treatment", "Replicate"))
ggplot(clinicalData, mapping = aes(x = Replicate, y = Value)) +
  geom_boxplot() +
...
## Part III - transforming the data, cleaning values and calculating new values
