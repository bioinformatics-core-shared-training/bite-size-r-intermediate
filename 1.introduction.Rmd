...
We can notice that there are `r nrow(iris)` rows and `r ncol(iris)` columns. There is also a function in R, `dim`, that will print the dimensions for us. The `colnames` function will also print the names of the functions.
