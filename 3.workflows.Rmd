...
> pad to three digits the ID variable of the data frame created by trimming white space from the sex variable from the patients data frame
...
With the workflow we have developed in the previous exercises, we can add extra steps to arrange by select the candidates with the highest BMI prior to writing to a file.
