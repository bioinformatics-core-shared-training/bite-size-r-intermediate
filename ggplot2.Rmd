...
```{r, bar_simple}
pcPlot <- ggplot(data=patients_clean[1:3,],
        mapping=aes(x=ID,y=Weight))

pcPlot_bar <- pcPlot+geom_bar(stat="identity") 
...
- [More material](http://sharpstatistics.co.uk/r/ggplot2-guide/)
