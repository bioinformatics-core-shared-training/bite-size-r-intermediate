...
[Link_to_Rmarkdown](http://mrccsc.github.io/ggplot2_exercise1.Rmd)
...
pcPlot <- ggplot(data=patients_clean,
                 aes(x=Height,y=Weight,size=BMI))
pcPlot + geom_point() + scale_size_continuous(range = c(3,6) ,breaks=c(25,35),labels=c("Good","Not So Good"))
...
- Theme elements in the old theme which have not been specified in new theme are replaced too by blank theme elements.
...
[Link_to_Rmarkdown](http://mrccsc.github.io/ggplot2_exercise2.Rmd)
