...
p = ggplot(data=patients_clean,aes(x=Sex,y=Height))
p +
...
p = ggplot(data=patients_clean,aes(x=Sex,y=Height,fill=Smokes))
p +
    geom_violin(aes(x=Sex,y=Height)) +
...
p = ggplot(data=patients_clean, aes(x=Height, y=Weight, colour=Sex))
